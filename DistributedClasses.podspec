#
#  Be sure to run `pod spec lint DistributedClasses.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
  Distributed Classes builds upon Distributed Objects to transparently allow multiple processes to share classes as if they were native to each process.
  ...
  s.author             = { "Matt Clarke" => "matt@incendo.ws" }
  s.social_media_url   = "http://twitter.com/_Matchstic"
