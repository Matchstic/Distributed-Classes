 ...
 */
-(nonnull NSData*)authenticationDataForComponents:(NSArray*)components andSessionKey:(char*)key;
 ...
 */
-(nonnull NSData*)encryptData:(NSData*)plaintext andSessionKey:(char*)key;
 ...
 */
-(nonnull NSData*)decryptData:(NSData*)ciphertext andSessionKey:(char*)key;
