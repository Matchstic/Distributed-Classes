...
/**
 ...
 @return Data to be appended to the message, or <code>[NSData data]</code>.
 */
...
/**
 ...
 @discussion Both the main body of the message AND the authentication data provided by your delegate will be subject to encryption here. It is recommended to do any message integrity checks here, such as via a MAC.
